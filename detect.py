        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                if opt.track:
                    ...
                    for *xyxy, obj_id, cls_pred in tracked_objects:
                        ...
                        if len(tracksUniqueObj[obj_id]) == 10:
                            ...
                            if angle1 > angle2:
                                print('\n\n\n\n\nEmergency venicle comes to the v1 direction!\n\n\n\n\n')
                            else:
                                print('\n\n\n\n\nEmergency venicle comes to the v2 direction!\n\n\n\n\n')
                            cutoffTrafficControl += 1

                            # Visualization of tracks
                            # for i in range(len(tracksUniqueObj[obj_id]) - 4):
                            #     cv2.line(im0, tuple(tracksUniqueObj[obj_id][i][0][2:]), tuple(tracksUniqueObj[obj_id][i+4][0][2:]), color=(0, 255, 0), thickness=1)
                ...
                for *xyxy, conf, _, cls in det:
                    ...
                    if (save_img or view_img) and not opt.track:  # Add bbox to image
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='newData/newData.data', help='newData.data file path')
    parser.add_argument('--weights', type=str, default='weights/best.pt', help='path to weights file')
    parser.add_argument('--source', type=str, default='newData/inference/', help='source')  # input file/folder, 0 for webcam
    ...
    parser.add_argument('--track', action='store_true', help="Track objects")  # tracking
